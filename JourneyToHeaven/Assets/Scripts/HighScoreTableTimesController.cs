...
// highScoreTableTimes is a child of highScoreTable
public class HighScoreTableTimesController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (highScoreList.list.Count > 0)
        {
            ...
            string highScoreTableTimesText = "";
            for (int i = 0; i < numberOfEntries; i++)
            {
                highScoreTableTimesText += highScoreList.list[i].timeText + "\n";
            }
            tmpText.text = highScoreTableTimesText;
        }
    }
}